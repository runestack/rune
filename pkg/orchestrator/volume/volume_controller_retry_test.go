...
func setupVolumeControllerWithOptions(t *testing.T, opts Options) (context.Context, context.CancelFunc, *store.TestStore, Controller) {
	t.Helper()
...
func TestVolumeController_RetryThenStalled(t *testing.T) {
	...
	ctx, _, ts, _ := setupVolumeControllerWithOptions(t, Options{
