...
// FakeController is the test double for *Controller. One
...
type FakeController struct {
	...
	RestartInstanceFunc     func(ctx context.Context, instance *types.Instance, reason RestartReason) error
...
// NewFakeController creates a new test instance controller
...
// GetInstanceByID implements Controller interface
func (c *FakeController) GetInstanceByID(ctx context.Context, namespace, instanceID string) (*types.Instance, error) {
	return nil, nil
}

// ListInstances records a call to list instances
func (c *FakeController) ListInstances(ctx context.Context, namespace string) ([]*types.Instance, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) ListRunningInstances(ctx context.Context, namespace string) ([]*types.Instance, error) {
...
func (c *FakeController) CreateInstance(ctx context.Context, service *types.Service, instanceName string, ordinal int) (*types.Instance, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) RetryCreateInstance(ctx context.Context, service *types.Service, instance *types.Instance) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) RecreateInstance(ctx context.Context, service *types.Service, instance *types.Instance) (*types.Instance, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) UpdateInstance(ctx context.Context, service *types.Service, instance *types.Instance) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) DeleteInstance(ctx context.Context, instance *types.Instance) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) GetInstanceStatus(ctx context.Context, instance *types.Instance) (*types.InstanceStatusInfo, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) IsInstanceCompatibleWithService(ctx context.Context, instance *types.Instance, service *types.Service) (bool, string) {
...
func (c *FakeController) SetEndpointPublisher(_ EndpointPublisher, _ string) {}
...
func (c *FakeController) RepublishServiceByInstance(_ context.Context, _ *types.Instance) {
}

// RepublishService is a no-op on the fake.
func (c *FakeController) RepublishService(_ context.Context, _ *types.Service) {
}

// SetMountResolver is a no-op on the fake.
func (c *FakeController) SetMountResolver(_ MountResolver) {}

// SetEventLog is a no-op on the fake.
func (c *FakeController) SetEventLog(_ events.EventLog) {}

func (c *FakeController) CollectRunningInstances(ctx context.Context) (map[string]*RunningInstance, error) {
...
func (c *FakeController) GetInstanceLogs(ctx context.Context, instance *types.Instance, opts types.LogOptions) (io.ReadCloser, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) Dial(ctx context.Context, instance *types.Instance, port uint32) (net.Conn, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) Exec(ctx context.Context, instance *types.Instance, options types.ExecOptions) (types.ExecStream, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) ExecDebug(ctx context.Context, instance *types.Instance, options types.ExecOptions) (types.ExecStream, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
	if c.ExecError != nil {
		return nil, c.ExecError
...
func (c *FakeController) RestartInstance(ctx context.Context, instance *types.Instance, reason RestartReason) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) WithdrawServiceInstances(ctx context.Context, service *types.Service, instances []*types.Instance) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) ClassifyInstance(ctx context.Context, instance *types.Instance, service *types.Service) CompatVerdict {
...
func (c *FakeController) StopInstance(ctx context.Context, instance *types.Instance) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) AddInstance(instance *types.Instance) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *FakeController) GetInstance(ctx context.Context, namespace, instanceID string) (*types.Instance, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
