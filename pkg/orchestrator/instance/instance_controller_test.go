...
func setupTestController(t *testing.T) (context.Context, *store.TestStore, *runner.TestRunner, *Controller) {
...
func controllerTestStore(c *Controller) *store.TestStore {
