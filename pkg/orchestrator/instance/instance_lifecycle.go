...
func (c *Controller) GetInstanceByID(ctx context.Context, namespace, instanceID string) (*types.Instance, error) {
	return c.store.GetInstanceByID(ctx, namespace, instanceID)
}

func (c *Controller) ListInstances(ctx context.Context, namespace string) ([]*types.Instance, error) {
...
func (c *Controller) ListRunningInstances(ctx context.Context, namespace string) ([]*types.Instance, error) {
...
func (c *Controller) CreateInstance(ctx context.Context, service *types.Service, instanceName string, ordinal int) (*types.Instance, error) {
...
func (c *Controller) RetryCreateInstance(ctx context.Context, service *types.Service, instance *types.Instance) error {
	if instance == nil {
...
// is scheduled.
func (c *Controller) runCreateAttempt(ctx context.Context, service *types.Service, instance *types.Instance) error {
...
func (c *Controller) RecreateInstance(ctx context.Context, service *types.Service, existingInstance *types.Instance) (*types.Instance, error) {
...
func (c *Controller) UpdateInstance(ctx context.Context, service *types.Service, instance *types.Instance) error {
...
func (c *Controller) StopInstance(ctx context.Context, instance *types.Instance) error {
...
func (c *Controller) DeleteInstance(ctx context.Context, instance *types.Instance) error {
...
func (c *Controller) RestartInstance(ctx context.Context, instance *types.Instance, reason RestartReason) error {
	...
	if reason == RestartReasonManual {
		...
		case types.RestartPolicyOnFailure:
			...
			isFailureRelated := reason == RestartReasonFailure || reason == RestartReasonHealthCheckFailure
			if !isFailureRelated {
...
func (c *Controller) CollectRunningInstances(ctx context.Context) (map[string]*RunningInstance, error) {
