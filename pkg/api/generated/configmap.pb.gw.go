...
func request_ConfigmapService_PatchConfigmap_0(ctx context.Context, marshaler runtime.Marshaler, client ConfigmapServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PatchConfigmapRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.PatchConfigmap(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ConfigmapService_PatchConfigmap_0(ctx context.Context, marshaler runtime.Marshaler, server ConfigmapServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PatchConfigmapRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.PatchConfigmap(ctx, &protoReq)
	return msg, metadata, err
...
func request_ConfigmapService_ListConfigmapVersions_0(ctx context.Context, marshaler runtime.Marshaler, client ConfigmapServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListConfigmapVersionsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ListConfigmapVersions(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ConfigmapService_ListConfigmapVersions_0(ctx context.Context, marshaler runtime.Marshaler, server ConfigmapServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListConfigmapVersionsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListConfigmapVersions(ctx, &protoReq)
	return msg, metadata, err

}

func request_ConfigmapService_RollbackConfigmap_0(ctx context.Context, marshaler runtime.Marshaler, client ConfigmapServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RollbackConfigmapRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.RollbackConfigmap(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ConfigmapService_RollbackConfigmap_0(ctx context.Context, marshaler runtime.Marshaler, server ConfigmapServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RollbackConfigmapRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RollbackConfigmap(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterConfigmapServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConfigmapServiceServer) error {
	...
	mux.Handle("POST", pattern_ConfigmapService_PatchConfigmap_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/rune.api.ConfigmapService/PatchConfigmap", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/PatchConfigmap"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ConfigmapService_PatchConfigmap_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ConfigmapService_PatchConfigmap_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ConfigmapService_ListConfigmapVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/rune.api.ConfigmapService/ListConfigmapVersions", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/ListConfigmapVersions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ConfigmapService_ListConfigmapVersions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ConfigmapService_ListConfigmapVersions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ConfigmapService_RollbackConfigmap_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/rune.api.ConfigmapService/RollbackConfigmap", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/RollbackConfigmap"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ConfigmapService_RollbackConfigmap_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ConfigmapService_RollbackConfigmap_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterConfigmapServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConfigmapServiceClient) error {
	...
	mux.Handle("POST", pattern_ConfigmapService_PatchConfigmap_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rune.api.ConfigmapService/PatchConfigmap", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/PatchConfigmap"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ConfigmapService_PatchConfigmap_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ConfigmapService_ListConfigmapVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rune.api.ConfigmapService/ListConfigmapVersions", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/ListConfigmapVersions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ConfigmapService_ListConfigmapVersions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ConfigmapService_RollbackConfigmap_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rune.api.ConfigmapService/RollbackConfigmap", runtime.WithHTTPPathPattern("/rune.api.ConfigmapService/RollbackConfigmap"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ConfigmapService_RollbackConfigmap_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ConfigmapService_PatchConfigmap_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rune.api.ConfigmapService", "PatchConfigmap"}, ""))
	...
	pattern_ConfigmapService_ListConfigmapVersions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rune.api.ConfigmapService", "ListConfigmapVersions"}, ""))

	pattern_ConfigmapService_RollbackConfigmap_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rune.api.ConfigmapService", "RollbackConfigmap"}, ""))
)
...
var (
	...
	forward_ConfigmapService_PatchConfigmap_0 = runtime.ForwardResponseMessage
	...
	forward_ConfigmapService_ListConfigmapVersions_0 = runtime.ForwardResponseMessage

	forward_ConfigmapService_RollbackConfigmap_0 = runtime.ForwardResponseMessage
)
