...
func request_WatchService_Subscribe_0(ctx context.Context, marshaler runtime.Marshaler, client WatchServiceClient, req *http.Request, pathParams map[string]string) (WatchService_SubscribeClient, runtime.ServerMetadata, error) {
...
func RegisterWatchServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WatchServiceServer) error {
	...
	mux.Handle("POST", pattern_WatchService_Subscribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterWatchServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WatchServiceClient) error {
	...
	mux.Handle("POST", pattern_WatchService_Subscribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rune.api.WatchService/Subscribe", runtime.WithHTTPPathPattern("/rune.api.WatchService/Subscribe"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_WatchService_Subscribe_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_WatchService_Subscribe_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_WatchService_Subscribe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rune.api.WatchService", "Subscribe"}, ""))
)

var (
	forward_WatchService_Subscribe_0 = runtime.ForwardResponseStream
)
